...
export const COUNTRY_TOLL_INFO: Record<string, CountryTollInfo> = {
  ...
  FR: { name: "France",              vignette: false, hasTolls: true, bbox: [-5.2, 41.3,  9.6, 51.1] },
  IT: { name: "Italy",               vignette: false, hasTolls: true, bbox: [ 6.6, 35.5, 18.5, 47.1] },
  ES: { name: "Spain",               vignette: false, hasTolls: true, bbox: [-9.4, 35.9,  4.4, 43.8] },
  PT: { name: "Portugal",            vignette: false, hasTolls: true, bbox: [-9.5, 36.8, -6.2, 42.2] },
  HR: { name: "Croatia",             vignette: false, hasTolls: true, bbox: [13.5, 42.4, 19.4, 46.6] },
  RS: { name: "Serbia",              vignette: false, hasTolls: true, bbox: [18.8, 42.2, 23.0, 46.2] },
  BA: { name: "Bosnia & Herzegovina",vignette: false, hasTolls: true, bbox: [15.7, 42.6, 19.6, 45.3] },
  ME: { name: "Montenegro",          vignette: false, hasTolls: true, bbox: [18.4, 41.8, 20.4, 43.6] },
  AL: { name: "Albania",             vignette: false, hasTolls: true, bbox: [19.3, 39.6, 21.1, 42.7] },
  GR: { name: "Greece",              vignette: false, hasTolls: true, bbox: [19.4, 34.8, 28.3, 42.0] },
  NO: { name: "Norway",              vignette: false, hasTolls: true, bbox: [ 4.6, 57.9, 31.1, 71.2] },
  PL: { name: "Poland",              vignette: false, hasTolls: true, bbox: [14.1, 49.0, 24.2, 54.8] },
  TR: { name: "Turkey",              vignette: false, hasTolls: true, bbox: [26.0, 35.8, 44.8, 42.1] },

  // ── Toll-free for private cars ────────────────────────────────────────────

  DE: { name: "Germany",     vignette: false, hasTolls: false, bbox: [ 5.9, 47.3, 15.0, 55.1] },
  NL: { name: "Netherlands", vignette: false, hasTolls: false, bbox: [ 3.3, 50.7,  7.2, 53.6] },
  BE: { name: "Belgium",     vignette: false, hasTolls: false, bbox: [ 2.5, 49.5,  6.4, 51.5] },
  LU: { name: "Luxembourg",  vignette: false, hasTolls: false, bbox: [ 5.7, 49.4,  6.5, 50.2] },
  DK: { name: "Denmark",     vignette: false, hasTolls: false, bbox: [ 8.1, 54.6, 15.2, 57.8] },
  SE: { name: "Sweden",      vignette: false, hasTolls: false, bbox: [11.0, 55.3, 24.2, 69.1] },
  FI: { name: "Finland",     vignette: false, hasTolls: false, bbox: [20.0, 59.8, 31.6, 70.1] },
  LT: { name: "Lithuania",   vignette: false, hasTolls: false, bbox: [20.9, 53.9, 26.8, 56.5] },
  LV: { name: "Latvia",      vignette: false, hasTolls: false, bbox: [21.0, 55.7, 28.2, 57.8] },
  EE: { name: "Estonia",     vignette: false, hasTolls: false, bbox: [21.8, 57.5, 28.2, 59.7] },
  UA: { name: "Ukraine",     vignette: false, hasTolls: false, bbox: [22.1, 44.4, 40.2, 52.4] },
  BY: { name: "Belarus",     vignette: false, hasTolls: false, bbox: [23.2, 51.3, 32.8, 56.2] },
};
